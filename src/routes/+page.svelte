...
<Form formName="Registre d' Usuari">
	<Input
		divId="div-name"
	...
	<div class="mt-5 p-2">
		<CustomButton
			btnClasses={'text-white w-full bg-primary-50 hover:bg-secondary-50 hover:shadow-custom focus:outline-none focus:ring-0 border-0 hover:scale-50 transition-transform mt-5'}
